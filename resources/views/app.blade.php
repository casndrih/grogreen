...
<body>
    ...
    @include('Frontend.toast.index')
    
    @include('Frontend.modal.authentication-modal')
    ...
    <script src="{{ URL::asset('js/product-search.js') }}"></script>
    <script src="{{ URL::asset('js/not-ready.js') }}"></script>
